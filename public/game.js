...
export const SHIP_DATA = {
    ...
    'tank': { name: 'V.G. TITAN', price: 1200000, hp: 7, speed: 400, damage: 8, fireRate: 0.12, missileCooldown: 1.2, missileCount: 4, color: '#00ff44', bulletType: 'piercing', desc: 'Heavy armor. Piercing shots.', passive: 'Iron Will: +1 HP per 4 kills.' },
    ...
    'eclipse': { name: 'ECLIPSE SERAPH', price: 4000000, hp: 7, speed: 500, damage: 12, fireRate: 0.05, missileCooldown: 0.7, missileCount: 6, color: '#66ccff', bulletType: 'piercing', desc: 'Angel core. Enhanced hull.', passive: 'Siphon Core: Every 12 kills heals 1 HP.' },
    ...
    'guardian': { name: 'GALAXY GUARDIAN', price: 7500000, hp: 8, speed: 380, damage: 8, fireRate: 0.10, missileCooldown: 1.2, missileCount: 5, color: '#ffffff', bulletType: 'normal', desc: 'Elite protector. High HP.', passive: 'Fortress Protocol: Damage capped at 1 per hit. +1 HP per 5 kills.' },
    // ── Tier 4: Advanced ────────────────────────────────
    ...
    'juggernaut': { name: 'JUGGERNAUT', price: 15000000, hp: 10, speed: 380, damage: 10, fireRate: 0.12, missileCooldown: 1.2, missileCount: 7, color: '#ff9900', bulletType: 'piercing', desc: 'God of War. Heals on kill.', passive: 'Unstoppable: Below 30% HP, take 50% less damage.' },
    ...
    'phoenix': { name: 'CELESTIAL PHOENIX', price: 33000000, hp: 11, speed: 530, damage: 26, fireRate: 0.07, missileCooldown: 0.6, missileCount: 10, color: '#ffa500', bulletType: 'explosive', desc: 'Mythic firebird. Ashen recovery.', passive: 'Ashen Recovery: Every 10 missile kills heals 1 HP.' },
    'starborn': { name: 'STARBORN TITAN', price: 40000000, hp: 11, speed: 480, damage: 18, fireRate: 0.04, missileCooldown: 0.5, missileCount: 9, color: '#99ffcc', bulletType: 'railgun', desc: 'Mythic relic. Stellar infusion.', passive: 'Stellar Infusion: Every 10 kills heals 1 HP.' },
    ...
    'nemesis': {
        ...
        desc: '☠ Achievement: GOD OF WAR. Passive: every 3 kills adds 1 HP (max 50). Explosive rounds detonate twice.',
        passive: 'God of War: Every 3 kills +1 HP (max 50). Explosives detonate twice.',
    ...
    'celestial': {
        ...
        desc: '🌠 Rank: ACE COMMANDER. Passive: Divine Radiance. Every 8 missile kills heals 1 HP. Missiles auto-split.',
        passive: 'Divine Radiance: Every 8 missile kills heals 1 HP. Missiles auto-split.',
